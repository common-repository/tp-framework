 ...
 */
function tpfw_form_datetime( $settings, $value = '' ) {
	 ...
	 * Css Class
	 */
	$css_class = 'tpfw-field tpfw-datetime';
	...
	return sprintf( '<div class="%s"><input class="tpfw_value" type="text" %s/><i class="fa fa-clock-o" aria-hidden="true"></i></div>', $css_class, implode( ' ', $attrs ) );
}
