 ...
 */
function tpfw_form_icon_picker( $settings, $value = '' ) {

	$attrs = array();

	$css_class = 'tpfw-field tpfw-icon_picker';
	...
	if ( !has_filter( 'tpfw_source_' . $source_font ) ) {
		$source_font = 'fontawesome';
	}

	$arr = apply_filters( 'tpfw_source_' . $source_font, array() );

	ob_start();

	?>
	<div class="<?php echo esc_attr( $css_class ) ?>">
		<select class="tpfw_value" <?php echo implode( ' ', $attrs ) ?>>
			<?php
			if ( !empty( $arr ) ) {
				echo '<option value="">' . esc_attr__( 'No icon', 'tp-framework' ) . '</option>';
 ...
 */
function tpfw_source_fontawesome( $icons ) {
...
add_filter( 'tpfw_source_fontawesome', 'tpfw_source_fontawesome' );
