...
/**
 * Parse string like "title:Tpfw is useful|author:quangdung" to array('title' => 'Tpfw is useful', 'author' => 'quangdung')
 *
 * @param $value
 * @param array $default
 *
 ...
 * @return string
 */
function tpfw_build_link_attrs( $value ) {
	
	$arr = tpfw_build_link( $value );
	$arr['href'] = $arr['url'];
	unset( $arr['url'] );
