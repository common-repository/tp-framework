 ...
 *
 * @class     Tpfw_Customize_Select_Control
...
if ( class_exists( 'WP_Customize_Control' ) ):
	...
	/**
	 * Tpfw_Customize_Select_Control Class
	 */
	class Tpfw_Customize_Select_Control extends WP_Customize_Control {

		public $type = 'tpfw_select';
		...
		public function content_template() {
			...
			<label class="tpfw-field tpfw-select">
				<# if ( data.label ) { #>
