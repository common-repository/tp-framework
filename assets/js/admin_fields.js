...
jQuery(function ($) {
     ...
     * Field radios
     */
    if (document.getElementsByClassName('tpfw-radios')) {
        $document.on('change', '.tpfw-radios input[type="radio"]', function (e) {
            var $this = $(this);
            var $ul = $this.closest('ul');
            $ul.find('input').removeAttr('checked');
            $this.attr('checked', 'checked');
            $ul.prev('input.tpfw_value').val($this.val()).trigger('change');
        });
    }
     ...
     * @since 1.0.4
     */
    if (document.getElementsByClassName('tpfw-upload')) {
        $('.tpfw-upload').tpfwUpload();
    }
     ...
     * @since 1.0.9
     */
    if (document.getElementsByClassName('tpfw-textfield-multiple')) {
        $('.tpfw-textfield-multiple').tpfwTextfields();
    }
